    ...
    public class GraphBackgroundLayer : GraphLayer
    {
        ...
        public override void ProcessEvent()
        {
            ...
            if (Event.current.type == EventType.MouseDrag && Event.current.button == 2 &&
                posotion.Contains(Event.current.mousePosition))
            {
            ...
            //取消选中
            if (posotion.MouseOn() && !IsMouseOverAnyState(context.currentChildStatesData) &&
                EventExtension.IsMouseDown(0))
            {
            ...
            //右键菜单
            if (posotion.MouseOn() && !IsMouseOverAnyState(context.currentChildStatesData) &&
                EventExtension.IsMouseUp(1) && this.context.controller != null)
            {
